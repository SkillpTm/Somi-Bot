...
Originally it was created to fullfil all needs of Somicord.</p>
...
<ul>
	...
	<li>
		<p>🎵 Display your LastFm listening history, top artists, recent tracks and more statistics directly in Discord.</p>
	</li>
	<li>
		<p>🛡️ Access essential moderation tools like muting, banning, slowmodes and more, to keep your server running smoothly.</p>
	</li>
	<li>
		<p>💬 Create custom commands that respond with text or images via link when triggered.</p>
	</li>
	<li>
		<p>⏰ Schedule reminders that deliver notifications days, months, or years in the future.</p>
	</li>
	<li>
		<p>🔔 Set up keyword alerts that notify you whenever specific words or phrases are mentioned anywhere in the server.</p>
	</li>
	<li>
		<p>🔗 Automatically convert Discord message links into readable embeds showing the original message content.</p>
	</li>
	<li>
		<p>🔧 Use practical everyday commands for tasks like local time, server info, weather, youtube searches and more.</p>
	</li>
</ul>
