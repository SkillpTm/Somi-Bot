...
from lib.utilities.config import TEXT_CHANNELS, LASTFM_TIMEFRAMES, LASTFM_TIMEFRAMES_TEXT, LASTFM_TIMEFRAMES_WEBSCRAPING, LASTFM_TIMEFRAMES_WEBSCRAPING_TEXT, LASTFM_COOKIES, LASTFM_HEADERS
